...
d3.json("https://earthquake.usgs.gov/earthquakes/feed/v1.0/summary/all_week.geojson").then(function(data) {
  ...
  L.geoJson(data, {
      ...
      style: styleInfo,
      onEachFeature: function(feature, layer){
        layer.bindPopup("<b>Major Earthquake</b><hr>Magnitude: " + feature.properties.mag + "<br>Location: " + feature.properties.place);
      }
    }).addTo(majorEarthquakes);
  //});
  // 8. Add the major earthquakes layer to the map. Not needed as it's mutually exclusive with ALl Earhquakes layer.
...
// Finally, we our legend to the map.
  ...
  //make allEarthquakes and majorEarthquakes mutually exclusive
  //change the legen being displayed
  //the setTimeout is needed to keep the 'overlayadd' event from firing multiple times
  map.on('overlayadd', function(eo) {
    if (eo.name === 'Earthquakes') {
      setTimeout(function() {
